...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            <h2 class="shadow-sm sombra-texto text-center mb-4 mt-5">Modificar una Inscripción</h2>
            <p class="lead shadow-sm sombra-texto legibilidad text-center">
                Para modificar los datos primero se debe elegir un asistente a modificar.
            </p>
